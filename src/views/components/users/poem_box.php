<div >
    <p><?php echo $id; ?></p>
    <p><?php echo $title; ?></p>
    <button class='update-poem-button' data-poem-id="<?php echo $id; ?>" data-poem-title="<?php echo $title; ?>">
        Update
    </button>
    <button class="delete-poem-button" data-poem-id="<?php echo $id; ?>" data-poem-title="<?php echo $title; ?>">
